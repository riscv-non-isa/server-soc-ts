...
#ifndef __BSA_ACS_COMMON_H__
#define __BSA_ACS_COMMON_H__
...
#define BSA_ACS_START(test_num) (((TEST_START_VAL) << STATE_BIT) | ((test_num) << TEST_NUM_BIT))
#define BSA_ACS_END(test_num) (((TEST_END_VAL) << STATE_BIT) | ((test_num) << TEST_NUM_BIT))

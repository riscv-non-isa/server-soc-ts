...
`git clone --recurse-submodules https://github.com/riscv-non-isa/server-soc-ts.git`

=== Building the Documentation

To start the build process, run `cd ./server-soc-ts && make build`.
